...
{
    return std::make_shared<IotHubClientWrapper>( iotHubUri, deviceId, statusFile, _impl->Proxy );
}
...
{
    return std::make_shared<IotHubClientWrapper>( connectionString, statusFile, _impl->Proxy );
}
